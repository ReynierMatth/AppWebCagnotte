...
<!DOCTYPE html>
<?php $idcagnotte=filter_input(INPUT_GET, "id" );
$_SESSION['getid']=$idcagnotte;?>
<html>
    <head>
    ...
    <body  style='background:url(../img/fondfruits.png); background-size: 100%;'>
        ...
        <div class="container">
            <div class="well well-lg"> 
                ...
                <form class="cree" method="post" role="form" action="../includephp/participer_inc.php">
                    <div class="form-group">
                        <label for="montant">Montant : </label>
                        <input type="number" class="form-control" name="montant" min="0" placeholder="Entrer un montant"/>
                    </div>
